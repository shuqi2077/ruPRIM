...
pub fn cumsum_f32(tensor: HostTensor, dim: usize) -> HostTensor {
    cumsum::<f32>(tensor, dim)
}

pub fn cumsum_f64(tensor: HostTensor, dim: usize) -> HostTensor {
    cumsum::<f64>(tensor, dim)
}

pub fn cumprod_f32(tensor: HostTensor, dim: usize) -> HostTensor {
    cumprod::<f32>(tensor, dim)
}

pub fn cumprod_f64(tensor: HostTensor, dim: usize) -> HostTensor {
...
pub fn cummin_f32(tensor: HostTensor, dim: usize) -> HostTensor {
    cumulative_op(tensor, dim, f32::INFINITY, |acc, val| {
        if val.is_nan() || val < acc { val } else { acc }
    })
}

pub fn cummin_f64(tensor: HostTensor, dim: usize) -> HostTensor {
...
pub fn cummax_f32(tensor: HostTensor, dim: usize) -> HostTensor {
    cumulative_op(tensor, dim, f32::NEG_INFINITY, |acc, val| {
        if val.is_nan() || val > acc { val } else { acc }
    })
}

pub fn cummax_f64(tensor: HostTensor, dim: usize) -> HostTensor {
