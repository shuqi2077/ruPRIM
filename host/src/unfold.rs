...
pub fn unfold(tensor: HostTensor, dim: usize, size: usize, step: usize) -> HostTensor {
    ...
    HostTensor::from_arc(tensor.data_arc(), output_layout, dtype)
}

// Type-specific wrappers (all delegate to the generic unfold which is now type-agnostic)

pub fn unfold_f32(tensor: HostTensor, dim: usize, size: usize, step: usize) -> HostTensor {
    unfold(tensor, dim, size, step)
}

pub fn unfold_f64(tensor: HostTensor, dim: usize, size: usize, step: usize) -> HostTensor {
    unfold(tensor, dim, size, step)
}

pub fn unfold_bool(tensor: HostTensor, dim: usize, size: usize, step: usize) -> HostTensor {
    unfold(tensor, dim, size, step)
}

pub fn unfold_int(tensor: HostTensor, dim: usize, size: usize, step: usize) -> HostTensor {
    unfold(tensor, dim, size, step)
}
