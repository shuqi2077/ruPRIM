...
pub trait BinaryOpIntFamily: Send + Sync + 'static {
    type BinaryOp<C: Int, N: Size>: BinaryOpInt<C, N>;
}

#[ruda]
pub trait BinaryOpInt<C: Int, N: Size>: 'static + Send + Sync {
...
pub struct BitwiseShrOp;
pub struct BitwiseShlOp;
...
pub fn kernel_scalar_binop_int<C: Int, N: Size, O: BinaryOpIntFamily>(
...
#[ruda(launch_unchecked, address_type = "dynamic")]
pub fn kernel_binop_int<C: Int, N: Size, O: BinaryOpIntFamily>(
...
pub fn launch_binop_int<R: Runtime, O: BinaryOpIntFamily>(
    lhs: RudaTensor<R>,
    rhs: RudaTensor<R>,
) -> RudaTensor<R> {
...
pub fn launch_scalar_binop_int<R: Runtime, O: BinaryOpIntFamily>(
    tensor: RudaTensor<R>,
    scalar: InputScalar,
) -> RudaTensor<R> {
