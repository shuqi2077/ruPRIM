...
use crate::reduce::{
    ...
    launch::{ReduceStrategy, RoutineStrategy, generate_vector_size_with_dtypes},
...
pub(crate) fn launch_reduce<Run: Runtime>(
    ...
    let (vector_size_input, vector_size_output) = generate_vector_size_with_dtypes::<Run>(
        client,
        &input,
        &output,
        reduce_axis,
        [problem.dtypes.input, problem.dtypes.output],
        vectorization_mode,
